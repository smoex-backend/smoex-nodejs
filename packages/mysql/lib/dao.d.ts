...
export declare abstract class BaseSql {
    ...
    protected createWhereSql(query: any): any;
    protected createOrderSql(order: string): any;
    protected createInsertSql(model: any): any;
...
export declare abstract class BaseDao<T, Q extends BaseQuery = any> extends BaseSql {
    private connection?;
